...
targetpc = '6285640228056' // Fitnah Target ( HAIKAL )
owner = '6285640228056' // Numbers Owner ( HW MODS WA )
ownerNumbers = ["6285640228056@s.whatsapp.net","6285640228056@s.whatsapp.net","6285640228056@s.whatsapp.net"]
...
res = await Haikal.prepareMessageFromContent(from,{
					"buttonsMessage": {
						"text": "",
						"videoMessage": {
						"url": "https://mmg.whatsapp.net/d/f/AvjviVhVyaBSFCgLagijG6guASOJATT-CPlBiz7HK1s-.enc",
						"mimetype": "video/mp4",
						"fileSha256": "obghgoTBKL0ln7zaRlFLVaOQEtF84JnsyFyvP9kLk5k=",
						"fileLength": "2475963",
						"seconds": 9,
						"mediaKey": "5SalFbARg+O/fGnWZUYfUQTptdM0GGzYaAi/dS17Vyk=",
						"height": 640,
						"width": 352,
						"fileEncSha256": "Mdw+Jt/kBpma72jKgKiesHf2zurT+HeyWZLLEsRsVmI=",
						"directPath": "/v/t62.7161-24/29944124_410847020564660_1257638141028134756_n.enc?ccb=11-4&oh=4070ada894e25bea755dfa020e7ee550&oe=617EA737",
						"mediaKeyTimestamp": "1633291563",
						"streamingSidecar": ""
					 },
						"contentText": `❏HW MODS WA❏
▬▭▬▭▬▭▬▭▬▬▭▬▭
Hai ${pushname}
...
Haikal.sendMessage(from, anu, image, { quoted: kal, thumbnail: fs.readFileSync('./stik/Ahhikal.jpg')})
break
case 'anal':
if (!isGroup) return reply(mess.only.group)
if (!isNsfw) return reply(`Fitur Nsfw Belum Aktif Di Grup Ini\nKetik: ${prefix}nsfw 1 \nUntuk Mengaktifkan`)
...
Haikal.sendMessage(from, kon, image, { quoted: kal, thumbnail: fs.readFileSync('./stik/Ahhikal.jpg')})
break
case 'lesbian':
if (!isGroup) return reply(mess.only.group)
if (!isNsfw) return reply(`Fitur Nsfw Belum Aktif Di Grup Ini\nKetik: ${prefix}nsfw 1 \nUntuk Mengaktifkan`)
...
Haikal.sendMessage(from, hai, image, { quoted: kal, thumbnail: fs.readFileSync('./stik/Ahhikal.jpg')})
break
case 'wallpaper':
if (!isGroup) return reply(mess.only.group)
if (!isNsfw) return reply(`Fitur Nsfw Belum Aktif Di Grup Ini\nKetik: ${prefix}nsfw 1 \nUntuk Mengaktifkan`)
...
Haikal.sendMessage(from, buffer, image, { quoted: kal, thumbnail: fs.readFileSync('./stik/Ahhikal.jpg')})
break
case  'blowjob':
if (!isGroup) return reply(mess.only.group)
if (!isNsfw) return reply(`Fitur Nsfw Belum Aktif Di Grup Ini\nKetik: ${prefix}nsfw 1 \nUntuk Mengaktifkan`)
