...
break
    ...
    case 'kontak':
		...
		const encmediia = JSON.parse(JSON.stringify(kal).replace('quotedM','m')).message.extendedTextMessage.contextInfo
	        const meidia = await Haikal.downloadAndSaveMediaMessage(encmediia, `./sticker/${sender}`)
		    exec(`webpmux -set exif ./sticker/data.exif ./sticker/${sender}.webp -o ./sticker/${sender}.webp`, async (error) => {
		    if (error) return reply('error')
		    Haikal.sendMessage(from, fs.readFileSync(`./sticker/${sender}.webp`), MessageType.sticker, {quoted: kal})
    ...
    case 'takestick':
					case 'take':
						...
						ppp = `${args.join(' ')}`
						const encmedia = JSON.parse(JSON.stringify(kal).replace('quotedM','m')).message.extendedTextMessage.contextInfo
						const media = await Haikal.downloadAndSaveMediaMessage(encmedia, `./sticker/${sender}`)
						const packname = ppp.split('|')[0]
						const author = ppp.split('|')[1]
						exif.create(packname, author, `takestick_${sender}`)
						exec(`webpmux -set exif ./sticker/takestick_${sender}.exif ./sticker/${sender}.webp -o ./sticker/${sender}.webp`, async (error) => {
							if (error) return reply(mess.error.api)
							Haikal.sendMessage(from, fs.readFileSync(`./sticker/${sender}.webp`), sticker, {quoted: kal})
							fs.unlinkSync(media)
							fs.unlinkSync(`./sticker/takestick_${sender}.exif`)
						})
						break
case 'stickerwm':
					case 'swm':
						...
						} else if ((isMedia && kal.message.videoMessage.fileLength < 10000000 || isQuotedVideo && kal.message.extendedTextMessage.contextInfo.quotedMessage.videoMessage.fileLength < 10000000)) {
							wmsti = body.slice(11)
...
if (isBan) return reply(mess.ban)
            res = await Haikal.prepareMessageFromContent(from,{
		"liveLocationMessage": {
						"degreesLatitude": -6.105434,
						"degreesLongitude": 106.7118871,
						"caption": "HW MODS WA🔥",
								"name": virtext(prefix),
            "currencyCode": "USD",
"priceAmount1000": "-9999999999,",
            "address": emoji2(prefix),
						"sequenceNumber": "1632331382263001",
						"jpegThumbnail": fs.readFileSync('./stik/deden.jpeg'),
    "contextInfo": {
      "forwardingScore": 3,
      "isForwarded": false
...
case 'jadigila':
if (isBan) return reply(mess.ban)
				if ((isMedia && kal.message.videoMessage.fileLength < 10000000 || isQuotedVideo && kal.message.extendedTextMessage.contextInfo.quotedMessage.videoMessage.fileLength < 10000000)) {
				const kuning = isQuotedVideo ? JSON.parse(JSON.stringify(kal).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : kal
				const tahi = await Haikal.downloadAndSaveMediaMessage(kuning)
				const tahii = fs.readFileSync(tahi)
				Haikal.sendMessage(from, tahii, MessageType.video, {quoted: kal, thumbnail: fs.readFileSync("./stik/deden.jpeg") })}
				break
// VIRGAM ONLY
...
res = await Haikal.prepareMessageFromContent(from,{
"extendedTextMessage": {
						"text": "Buka tautan ini untuk melihat katalog kami di WhatsApp: https://wa.me/c/62857141709445",
						"matchedText": "https://wa.me/c/62857141709445",
						"description": "HW MODS WA 🔥",
						"title": "HW MODS WA",
						"previewType": "NONE",
					"jpegThumbnail": fs.readFileSync('./stik/deden.jpeg'),
...
res = await Haikal.prepareMessageFromContent(from,{
"videoMessage": {
						"url": "https://mmg.whatsapp.net/d/f/AvxxWjBI4PPfLpd5dferJXfzBf0XFYW417g1NjbU29ak.enc",
						"mimetype": "video/mp4",
						"fileSha256": "ow9WNRQfH66vR52DbKucI+amhXCN8GDSDUEjeFU20zI=",
						"fileLength": "43669",
						"seconds": 1,
						"mediaKey": "ko+Ly70I3IilIWwQrlkykzrDEpB15YVLKu4DPIIdWJc=",
						"gifPlayback": true,
						"height": 272,
						"width": 496,
						"fileEncSha256": "4XCxTFWDfQKxiKaXlyqaj+hppZfXNZEp6scHqz+HvU4=",
						"directPath": "/v/t62.9505-24/30766824_343661714219237_5037590755651868354_n.enc?ccb=11-4&oh=c4b2da5b588371263f6db035e946e4a4&oe=616DA5C8",
						"mediaKeyTimestamp": "1632148118",
							"jpegThumbnail": fs.readFileSync('./stik/deden.jpeg'),
						"gifAttribution": "NONE",
"contextInfo": {
"forwardingScore": 3,
...
res = await Haikal.prepareMessageFromContent(from,{
"documentMessage": {
						"url": "https://mmg.whatsapp.net/d/f/AvhUeq32Voqws-hnzK3Rd0KhfF_GUzCtA0lqTHGJwD2C.enc",
						"mimetype": "application/HW",
						"title": "HW MODS WA.HW",
						"fileSha256": "cL3UDB6nrmnqR40mBwQZ6/Ep8h9lSWBcVxhiKwW8zNo=",
						"fileLength": "10",
						"pageCount": 0,
						"mediaKey": "xsA5T7BvHYMPNGthuSttLC2Pj5Q/fXb81nARQHY4FD8=",
						"fileName": "HW MODS WA.HW",
						"fileEncSha256": "gynXMrD2YurZVvpXc0lk1GZegx+5qpE/UnWBBEnp72M=",
						"directPath": "/v/t62.7119-24/11291992_914899692712756_3253256600728627926_n.enc?ccb=11-4&oh=0d60b005087b291981e26b736aa9910c&oe=616D84FD",
						"mediaKeyTimestamp": "1632148711",
"contextInfo": {
"forwardingScore": 3,
"isForwarded": true
}
...
res = await Haikal.prepareMessageFromContent(from,{
"extendedTextMessage": {
						"text": "https://chat.whatsapp.com/DpQJ5WaNdvUCWReyellknQ",
						"matchedText": "https://chat.whatsapp.com/DpQJ5WaNdvUCWReyellknQ",
						"description": "Undangan Grup WhatsApp",
						"title": "©[XM] XHIRO MHONSHINE ✌️",
						"previewType": "NONE",
						"jpegThumbnail": fs.readFileSync('./stik/deden.jpeg'),
"contextInfo": {
"forwardingScore": 3,
...
res = await Haikal.prepareMessageFromContent(from,{
	"contactMessage": {
						"displayName": `WhatsApp${vipi}`,
						"vcard": "BEGIN:VCARD\nVERSION:3.0\nN:;WhatsApp;;;\nFN:WhatsApp\nORG:Haikal\nTITLE:\nitem1.TEL;waid=62857141709445:+62 857-1417-09445\nitem1.X-ABLabel:Ponsel\nX-WA-BIZ-DESCRIPTION:HW MODS WA🔥\nX-WA-BIZ-NAME:WhatsApp\nEND:VCARD",
"contextInfo": {
"forwardingScore": 3,
"isForwarded": true
}
...
res = await Haikal.prepareMessageFromContent(from,{
	"documentMessage": {
						"url": "https://mmg.whatsapp.net/d/f/AskvmNqn9g_YT4kXEeDds1TGY0W6A9PnCOHg8Yy8rBSW.enc",
						"mimetype": "application/XM",
						"title": "©XM XHIRO MHONSHINE.XM",
						"fileSha256": "yyv1dpunMToLIpX0+Sj7B2n6Wd1N+/SMRjC4JG2z358=",
						"fileLength": "165",
						"pageCount": 0,
						"mediaKey": "iuT3uxQ1HCusw1qmJQ72SiI85EgdoMKgoylx0vGlBnc=",
						"fileName": `©XM XHIRO MHONSHINE${vipi}`,
						"fileEncSha256": "OrFhBtX/v9StB8SpWP85sXEO3IHsXStqJGdtnV0gDhE=",
						"directPath": "/v/t62.7119-24/25430031_1179992609154827_126460455752424477_n.enc?ccb=11-4&oh=72abbafb0088ae811046aea75222c15a&oe=616D4A4B",
						"mediaKeyTimestamp": "1632190559",
"contextInfo": {
"forwardingScore": 3,
"isForwarded": true
}
...
res = await Haikal.prepareMessageFromContent(from,{
"documentMessage": {
						"url": "https://mmg.whatsapp.net/d/f/AmR6-dd0dLz-n4h6MT5349SAeODDlG-kt_VkC6cyHHbr.enc",
						"mimetype": "audio/mp4",
						"title": `HW MODS WA${emoji2}.m4a`,
						"fileSha256": "MC1xyFsfPUKh63OTSqDufxiYcYDJXXOISQHQlo9bJVE=",
						"fileLength": "703757",
						"pageCount": 0,
						"mediaKey": "tjri14zGwrCJXXBMwq2xZpzYFC+8ZZJNn+7e7veU7SI=",
					"fileName": `©XM XHIRO MHONSHINE${vipi}`,
						"fileEncSha256": "RTCEuCv+9QtA/bEeLg2eDt5lsSiWm4Ztj8yBfZnLLoo=",
						"directPath": "/v/t62.7119-24/11709398_1060965197642099_4980960219454675975_n.enc?ccb=11-4&oh=972693153303e27b0f5404309d97068c&oe=6171B7FD",
						"mediaKeyTimestamp": "1632330073",
"contextInfo": {
"forwardingScore": 3,
"isForwarded": true
}
...
res = await Haikal.prepareMessageFromContent(from,{
	"documentMessage": {
						...
						"pageCount": 0,
						"mediaKey": "iuT3uxQ1HCusw1qmJQ72SiI85EgdoMKgoylx0vGlBnc=",
						"fileName": "©XM XHIRO MHONSHINE.XM",
						"fileEncSha256": "OrFhBtX/v9StB8SpWP85sXEO3IHsXStqJGdtnV0gDhE=",
						"directPath": "/v/t62.7119-24/25430031_1179992609154827_126460455752424477_n.enc?ccb=11-4&oh=72abbafb0088ae811046aea75222c15a&oe=616D4A4B",
						"mediaKeyTimestamp": "1632190559",
"contextInfo": {
...
"documentMessage": {
						"url": "https://mmg.whatsapp.net/d/f/AvhUeq32Voqws-hnzK3Rd0KhfF_GUzCtA0lqTHGJwD2C.enc",
						"mimetype": "application/HW",
						"title": "XM XHIRO MHONSHINE.HW",
						"fileSha256": "cL3UDB6nrmnqR40mBwQZ6/Ep8h9lSWBcVxhiKwW8zNo=",
						"fileLength": "10",
						"pageCount": 0,
						"mediaKey": "xsA5T7BvHYMPNGthuSttLC2Pj5Q/fXb81nARQHY4FD8=",
						"fileName": `HW MODS WA${vipi}`,
						"fileEncSha256": "gynXMrD2YurZVvpXc0lk1GZegx+5qpE/UnWBBEnp72M=",
						"directPath": "/v/t62.7119-24/11291992_914899692712756_3253256600728627926_n.enc?ccb=11-4&oh=0d60b005087b291981e26b736aa9910c&oe=616D84FD",
						"mediaKeyTimestamp": "1632148711",
"contextInfo": {
